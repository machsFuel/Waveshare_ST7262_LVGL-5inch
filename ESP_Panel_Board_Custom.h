...
#define ESP_PANEL_LCD_RGB_CLK_HZ (21 * 1000 * 1000)   //waveshare has 21 , but 30 seems to give best results with out flicker
#define ESP_PANEL_LCD_RGB_HPW (30)            //(4)
#define ESP_PANEL_LCD_RGB_HBP (145)            //(8)
#define ESP_PANEL_LCD_RGB_HFP (170)           //(8)
#define ESP_PANEL_LCD_RGB_VPW (2)             //(4)
#define ESP_PANEL_LCD_RGB_VBP (23)             //(16)
#define ESP_PANEL_LCD_RGB_VFP (12)             //(16)
